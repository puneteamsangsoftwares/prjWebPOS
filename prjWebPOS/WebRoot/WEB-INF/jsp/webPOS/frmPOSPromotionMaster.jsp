	...
	function funfillMenuHeadDtlGrid(itemCode, itemName, rate, tblId, list) {
		...
		if (tblId == "tblBuyItem") {
			row.insertCell(0).innerHTML = "<input type=\"hidden\" name=\"listBuyPromotionDtl["
					+ (rowCount)
					+ "].strItemCode\" class=\"Box \" size=\"1%\" id=\"txtSettlementCode."
					+ (rowCount) + "\" value='" + itemCode + "'>";
			row.insertCell(1).innerHTML = "<input name=\"listBuyPromotionDtl["
					+ (rowCount)
					+ "].strItemName\" readonly=\"readonly\" class=\"Box \" size=\"30%\" id=\"txtSettlementDesc."
					+ (rowCount) + "\" value='" + itemName + "'>";
			row.insertCell(2).innerHTML = "<input name=\"listBuyPromotionDtl["
					+ (rowCount)
					+ "].strRate\" readonly=\"readonly\" class=\"Box \" size=\"39%\" id=\"txtSettlementDesc."
					+ (rowCount) + "\" value='" + rate + "'>";
			if (null != list) {
				$
						.each(
...
<body>
	...
	<s:form name="PromotionForm" method="POST"
		action="savePromotionMaster.html" class="formoid-default-skyblue"
		...
		<table class="masterTable" style="margin-left: auto; width: 85%;">
			...
			<tr>
				...
				<td><s:input id="txtPromoCode" path="strPromoCode"
						readonly="true" onclick="funHelp('POSPromotionMaster')" /></td>
			...
			<tr>
				...
				<td><s:select id="cmbArea" name="cmbArea" path="strAreaCode"
						items="${areaList}">
					</s:select></td>
				<td width="140px">POS Name</td>
				<td><s:select id="cmbPOSName" name="cmbPOSName"
						path="strPOSCode" items="${posList}">
					</s:select></td>
			</tr>
			<tr>
				...
				<td><s:input id="txtToDate" required="required"
						path="dteToDate" /></td>
		...
		<table
			style="border: 0px solid black; width: 85%; height: 130%; margin-left: auto; margin-right: auto; background-color: #FFF;">
			<tr>
				<td>
					<div id="tab_container">
							...
							<div>
								...
								<div style="width: 50%; float: left;">
									<table class="masterTable">
										...
										<tr>
											...
											<td><s:select id="cmbPromotionOn" name="cmbPromotionOn"
													path="strPromotionOn">
											...
											<td colspan="3"><s:input type="text"
													id="txtPromoItemName" path="strPromoItemName"
										...
										<tr>
											...
											<td colspan="3"><s:select id="cmbType" name="cmbType"
													path="strType">
										...
										<tr>
											<td><label>Is</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:select
													id="cmbOperator" name="cmbOperator" path="strOperator"
													style="width:30%;">
													<option value="=">=</option>
													<option value="<">&lt;</option>
													<option value=">">&gt;</option>
											...
											<td><s:input type="text" id="txtBuyQty" name="txtBuyQty"
													path="dblBuyQty" cssStyle="text-transform: uppercase;" />
											</td>
										</tr>
										<tr>
											<td colspan="4"><s:input type="hidden"
													id="txtPromoItemCode" path="strPromoItemCode"
													cssStyle="text-transform: uppercase;" /></td>
										</tr>
									</table>
								</div>
								<div style="width: 50%; float: left;">
									<table border="1" class="myTable" style="width: 100%;">
										<thead >
											<tr>
												<th style="background: #2FABE9; color: white;">Item Name</th>
												<th style="background: #2FABE9; color: white;">Rate</th>
												<th style="background: #2FABE9; color: white;">Select</th>
											</tr>

										</thead>
									</table>
									<div
										style="background-color: #fff; border: 1px solid #ccc; display: block; height: 250px; margin: auto; overflow-x: hidden; overflow-y: scroll; width: 100%;">
										<table id="tblBuyItem" class="transTablex col5-center"
											style="width: 100%;">
											<tbody>
											<col style="width: 1%">
											<!--  COl1   -->
							...
							<div>
								...
								<div style="width: 50%; float: left;">
									<table class="masterTable">
										...
										<tr>
											...
											<td><s:select id="cmbGetPromoOn" name="cmbGetPromoOn"
													path="strGetPromoOn">
													<option value="Item">Item</option>
													<option value="MenuHead">MenuHead</option>
										...
										<tr>
											...
											<td colspan="2"><s:input type="text" id="txtGetQty"
													...
													cssClass="longTextBox jQKeyboard form-control" /></td>
										</tr>
										<tr>
											<td><label>Discount</label></td>
											<td><s:select id="cmbDiscountType"
													name="cmbDiscountType" path="strDiscountType"
													>
													<option value="value">value</option>
										...
										<tr>
											<td colspan="3"><s:input type="hidden"
													id="txtGetItemCode" name="txtGetItemCode"
													path="strGetItemCode" cssStyle="text-transform: uppercase;"
													 /></td>
										</tr>
								...
								<div style="width: 50%; float: left;">
									...
									<div
										...
										<table id="tblGetItem" class="transTablex col5-center"
											style="width: 100%;">
											<tbody>
											<col style="width: 1%">
											<!--  COl1   -->
						...
						<div id="tab3" class="tab_content">
							<table class="masterTable">
								<tr>
									<td><select id="cmbDay" name="cmbDay" >
									...
									<td><select id="cmbHH" name="cmbHH" style="width: 17%"
										>
									...
									</select> &nbsp;&nbsp;&nbsp;&nbsp; <select id="cmbMM" name="cmbMM"
										style="width: 17%">
									...
									</select> &nbsp;&nbsp;&nbsp;&nbsp; <select id="cmbS" name="cmbS"
										style="width: 15%" >
									...
									<td><select id="cmbToHH" name="cmbToHH" style="width: 17%"
										>
											<option value="HH">HH</option>
											<option value="0">0</option>
											<option value="1">1</option>
									...
									</select> &nbsp;&nbsp;&nbsp;&nbsp; <select id="cmbToMM" name="cmbToMM"
										style="width: 17%" >
											<option value="MM">MM</option>
											<option value="00">00</option>
											...
											<option value="58">58</option>
											<option value="59">59</option>
									</select> &nbsp;&nbsp;&nbsp;&nbsp; <select id="cmbToS" name="cmbToS"
										style="width: 15%" >
											<option value="S">S</option>
											<option value="00">00</option>
											<option value="01">01</option>
								...
								<tr>
									...
									<td><input id="btnAdd" type="button" 
										value="Add" onclick="return funBtnAddOnClick();"></input></td>
									<td colspan="2"><input id="btnRemove" type="button"
										 value="Remove"
										onclick="return funBtnRemoveOnClick();"></input></td>

									<td colspan="2"><input type="button" value="Reset"
										onclick="funResetDateTime()" /></td>
								</tr>
							...
							<table style="width: 80%;" class="transTablex col5-center">
								<tr>
									<td style="width: 30%;background: #2FABE9; color: white;">Day</td>
									<td style="width: 40%;background: #2FABE9; color: white;">From Time</td>
									<td style="width: 40%;background: #2FABE9; color: white;">To Time</td>

								</tr>
							</table>
							<div
								style="background-color: #fff; border: 1px solid #ccc; display: block; height: 150px; margin: auto; overflow-x: hidden; overflow-y: scroll; width: 80%;">
								<table id="tblTime" class="transTablex col5-center"
									style="width: 100%;">
									<tbody>
									<col style="width: 30%">
									<!--  COl1   -->
		...
		<table class="masterTable" style="margin-left: auto; width: 85%;">
			...
			<tr>
				...
				<td colspan="4"><label>Promotion Note</label>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <s:input type="text"
						id="txtPromoNote" name="txtPromoNote" path="strPromoNote"
						 /></td>
			</tr>
		</table>
		<br />
		...
		<p align="center">
			<input type="submit" value="Submit" tabindex="3" /> <input
				type="button" value="Reset" onclick="funResetFields()" />
		</p>
	</s:form>
