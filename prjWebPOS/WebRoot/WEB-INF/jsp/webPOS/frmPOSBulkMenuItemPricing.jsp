...
<br/>
	...
	<s:form name="BulkPricingMaster" method="POST" action="updateBulkItemPricingMasterMaster.html?saddr=${urlHits}" target="_blank">
		...
		style="width: 1000px;">
    	 ...
    	 <dl id="Searchresult" style="width: 1000px; overflow-x: scroll; overflow-y: hidden;  margin-left:  auto;margin-right: auto; overflow:auto;"></dl> 
		<div id="Pagination" class="pagination" style="width: 1000px; margin-left: auto;margin-right: auto;">
