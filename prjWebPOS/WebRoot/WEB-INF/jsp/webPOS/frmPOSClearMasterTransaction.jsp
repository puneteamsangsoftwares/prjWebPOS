...
// 	funLoadProperty('All');
	...
	function funOnLoad(strHeadingType)
	{
		funLoadMastersData(strHeadingType);
		funLoadPosName();
	}

	
	function funLoadMastersData(strHeadingType)
	{
		var strType = $("#strHeader").val();
		...
		var searchurl=getContextPath()+"/loadMastersData.html?strHeadingType="+strHeadingType;
		 $.ajax({
			        type: "GET",
			        url: searchurl,
			        dataType: "json",
