		...
		var k=0;
		 ...
		 for(var i=0;i<len;i++)
			{ 
				...
				row.insertCell(k).innerHTML= '<br><lable style="width:120px; margin-left:150px; color: #0c6da8; " id="lblTime' + i + '"></lable><br> <lable style="width:120px; margin-left:50px; "  id="lblBillNo' + i + '"></lable><br><div id="bill' + i + '" class="divcells" onclick=\"funGetSelectedRowIndex(this)"></ div>';
			 k++;
...
<body onload="funLoadData()">
	...
	<s:form name="KDSForm" method="POST" action="funBillOrderProcess.html" class="formoid-default-skyblue" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:880px;min-width:150px;margin-top:2%;">


		<div class="title">
		
			<div id="mainDiv" style=" width: 100%; border: 1px solid #ccc; height: 600px; margin:auto; overflow-x: hidden; overflow-y: scroll; ">
