...
<head>
 ...
 // var str="../${pageContext.request.contextPath}/";
  ...
  function hello()
  {
	  //window.location.href=getContextPath()+"/resources/newdesign/demo/pages/forms/basic-forms.html";
	  //window.location.replace("../${pageContext.request.contextPath}");
	  //alert("from hello function");
	 // var str=getContextPath()+"/resources/newdesign/demo/pages/forms/basic-forms.html";
	  var searchurl=getContextPath()+"/sendRedirct.html?OperationFrom=HELLO";
	$.ajax({
		 type: "POST",
	        url: searchurl,
	  ...
	  //response.sendRedirect(getContextPath()+"/resources/newdesign/demo/pages/forms/basic-forms.html");
  })}
        ...
        <div class="mdc-list-group">
          <nav class="mdc-list mdc-drawer-menu">
            <div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-drawer-link" href="frmWebPOSBilling.html">
                <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon" aria-hidden="true">home</i>
                Dashboard
              </a>
            </div>
            <div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-drawer-link" href="../${pageContext.request.contextPath}/resources/newdesign/demo/pages/forms/basic-forms.html">
            ...
            <div class="mdc-list-item mdc-drawer-item">
              ...
              <div class="mdc-expansion-panel" id="ui-sub-menu">
                <nav class="mdc-list mdc-drawer-submenu">
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="../${pageContext.request.contextPath}/resources/newdesign/demo/pages/ui-features/buttons.html">
                      Buttons
                    </a>
                  </div>
                  <div class="mdc-list-item mdc-drawer-item">
                ...
                <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical">
                  <li class="mdc-list-item" role="menuitem">
                    <div class="item-thumbnail">
                      <img src="../${pageContext.request.contextPath}/resources/newdesign/assets/images/faces/face4.jpg" alt="user">
                    </div>
                    <div class="item-content d-flex align-items-start flex-column justify-content-center">
                  ...
                  <li class="mdc-list-item" role="menuitem">
                    <div class="item-thumbnail">
                      <img src="../${pageContext.request.contextPath}/resources/newdesign/assets/images/faces/face2.jpg" alt="user">
                    </div>
                    <div class="item-content d-flex align-items-start flex-column justify-content-center">
                  ...
                  <li class="mdc-list-item" role="menuitem">
                    <div class="item-thumbnail">
                      <img src="../${pageContext.request.contextPath}/resources/newdesign/assets/images/faces/face3.jpg" alt="user">
                    </div>
                    <div class="item-content d-flex align-items-start flex-column justify-content-center">
      ...
      <div class="page-wrapper mdc-toolbar-fixed-adjust">
		...
		<table width="100%" border="0">
			...
			<table width="97%" class="mdc-card info-card">
					...
					<div id="divOrder" class="mdc-card info-card3" style="border: 1px solid rgb(204, 204, 204);height: 700px;overflow: auto;width: 420px;display: block;padding: 0px;margin-top: 2px;margin-bottom: 2px;">
						...
						<tbody><tr>
							...
							<!-- <table id="tblSettleItemTableHead" style="width: 100%; height:40px; border-collapse: collapse;overflow: auto;
								...
								<table id="tblSettleItemTable"class="mdc-card info-card3">
								</table>
					</div>		</td>	
			...
			<table width="100%" class="mdc-card info-card2"  style="margin-top: -275px;">
						<tr>
							<td align="center">
						...
						<tr>
							...
							<table width="100%" border="0">
								<tr>
									...
									<td width="20%">
										<div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon search-text-field d-none d-md-flex">
										  <input id="txtAmount" class="mdc-text-field__input">
								...
								<tr>
									...
									<td width="20%">
										<div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon search-text-field d-none d-md-flex">
										  <input id="txtPaidAmount" class="mdc-text-field__input">
											  <div class="mdc-notched-outline mdc-notched-outline--upgraded">
												<div class="mdc-notched-outline__leading"></div>
												<div class="mdc-notched-outline__notch" style="">
												  <label for="text-field-hero-input" style=""></label>
									...
									<td width="15%">
										<h5 class="tablehead" nowrap>Discount Amount</h5>
									</td>
									<td width="30%">
										<div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon search-text-field d-none d-md-flex">
									...
									<td width="67%" colspan="4" align="right">
										<table>
											<tr>
												...
												<td>
													<h5 class="tablehead" nowrap><input type="radio" id="strDisountOn" name="strDisountOn" onclick="funItemDiscClicked()" value="group">
								...
								<tr>
									...
									<td width="20%">
										<div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon search-text-field d-none d-md-flex">
										<!--   <input class="mdc-text-field__input" id="lblCardBalance"> -->
					...
					<table width="100%" border="0">
						...
						<!-- 	  <table>
						 ...
						 <table width="80%">
								...
								<td><a href="#" id="btnPrint"  onclick="return funSaveBtnClicked()"><img src="../${pageContext.request.contextPath}/resources/newdesign/assets/images/printbt.png"></a>
								</td>
								<td><a href="#" id="btnSettle"  onclick="funClickedSettleBtnForDirectBiller()"><img src="../${pageContext.request.contextPath}/resources/newdesign/assets/images/settlebillbt.png"></a>
								</td>
								<td><a href="#" id="btnOpenBillItems"  onclick="funOpenBillItemButtonClicked(this)"><img src="../${pageContext.request.contextPath}/resources/newdesign/assets/images/showbillbt.png"></a>
								</td>
							</table> 
