...
<body>
	...
	<s:form name="ReprintDocuments" method="GET" action="frmViewData.html?saddr=${urlHits}" target="_blank" class="formoid-default-skyblue" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:880px;min-width:150px;margin-top:2%;">
	
	<div class="title" >
	
		<div style="width:20%;height:450px;margin:auto;float:left">
		...
		<div id="divBill" style="width:70%;margin-bottom:5px; overflow-x: hidden; overflow-y: scroll;float:right;margin-right: 4px;height:100%; ">
		  ...
		  <div style="width:70%;height:500px;margin:auto;margin-top:50px">
				<center>
					<div id="divDayEnd" style="width:50%;margin-bottom:5px;display: none; float:right;margin-right: 4px;height:300px;">
					</div>
				</center>
		  </div>
		  
		  <div class="col-lg-10 col-sm-10 col-xs-10" style="width: 70%; margin-left: 20%;">
	     		  	<p align="center">
	            		<div class="submit col-lg-4 col-sm-4 col-xs-4"><input type="button" value="View" onclick="funGetSelectedRowIndex(this,this)"/></div>
	           			<div class="submit col-lg-4 col-sm-4 col-xs-4"><input type="reset" value="Print" onclick="" /></div>
