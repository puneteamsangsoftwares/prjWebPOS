		...
		<div class="title">
			...
			<div class="row" style="background-color: #fff;margin-bottom: 5px;display: -webkit-box;">
					<div class="element-input col-lg-6" style="width: 20%;"> 
	    				<s:select id="cmbBusyTbl" name="cmbBusyTbl" path="strBusyTbl" items="${busyTblList}" />
	    			</div>
	    			<div class="element-input col-lg-6" style="width: 20%;margin-left: 30%;"> 
	    				<s:select id="cmbTable" name="cmbTable" path="strTableNo" items="${tableList}" />
	    			</div>
			...
			<div style=" width: 50%; height: 400px;float:left;  overflow-x: hidden; border-collapse: separate; overflow-y: scroll;">
					...
					<div style=" width: 100%;border: 1px solid #ccc;display: block; height: 250px;overflow-y: scroll; ">
					...
					<table border="1" style="width:100%;margin: auto;"  >
							<thead>
									<tr>
										<td style="width:50%; background: #78BEF9;">Description</td>
										<td style="width:15%; background: #78BEF9;">Quantity</td>
					...
					<table id="tblItem" style="width: 100%;">
							<tbody>    
			...
			<div style=" width: 50%; height: 400px;float:left;  overflow-x: hidden; border-collapse: separate; overflow-y: scroll;">
					...
					<div class="row" style="background-color: #fff;margin-bottom: 10px;display: block;margin-left: 0px;">
						    ...
						    <table id="tblMoveItem" style="width:100%">
								<tbody>    
			...
			<div class="col-lg-10 col-sm-10 col-xs-10" style="width: 70%;margin-left: 240px;">
				<p align="center">
					<div class="submit col-lg-4 col-sm-4 col-xs-4"><input id="btnAdd" type="button" value="OK" onclick="return btnAdd_onclick();"></input></div>
					<div class="submit col-lg-4 col-sm-4 col-xs-4"><input type="submit" value="Save" tabindex="3" /></div>
					<div class="submit col-lg-4 col-sm-4 col-xs-4"><s:input type="hidden" id="txtTableNo" path="jObjKOTItemList" /></div>
				</p>
			</div>
