...
<%}
	...
	function funCallFormAction() {
		...
		$.ajax({
			type : "GET",
			url : getContextPath() + "/checkOrderName.html?name=" + name
					+ "&code=" + code,
			async : false,
			dataType : "text",
			success : function(response) {
...
<body>
	...
	<s:form name="POSOrderMaster" method="POST"
		action="savePOSOrderMaster.html?saddr=${urlHits}"
		...
		<div class="title" style="margin-left: 25%;">
			<div class="row"
				...
				<div class="element-input col-lg-6"
					...
					<label class="title">Order Code</label>
				</div>
				<div class="element-input col-lg-6" style="width: 30%;">
					<s:input class="large" type="text" id="txtOrderCode"
						path="strOrderCode" readonly="true"
						ondblclick="funHelp('POSOrderMaster')" style="width: 100%;" />
				</div>
			</div>
			<div class="row"
				style="background-color: #fff; margin-bottom: 10px; display: -webkit-box;">
				<div class="element-input col-lg-6"
					style="width: 20%; margin-left: 10%">
					<label class="title">Order Desc</label>
				</div>
				<div class="element-input col-lg-6" style="width: 30%;">
					<s:input class="large" type="text" iid="txtOrderDesc"
						path="strOrderDesc" style="width: 100%;" />
				</div>
			</div>
			<div class="row"
				style="background-color: #fff; margin-bottom: 10px; display: -webkit-box;">
				<div class="element-input col-lg-6"
					style="width: 20%; margin-left: 10%">
					<label class="title">UpToTime</label>
				</div>
				<div class="element-input col-lg-6" style="width: 15%;">
					<s:select id="cmbHH" name="cmbHH" path="strHH">
				...
				<div class="element-input col-lg-6" style="width: 15%;">
					...
					<s:select id="cmbMM" name="cmbMM" path="strMM">
				...
				<div class="element-input col-lg-6" style="width: 15%;">
					<s:select id="cmbAMPM" name="cmbAMPM" path="strAMPM">
