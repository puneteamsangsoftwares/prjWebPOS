...
{		
	...
	**/
	...
	function funSendReportOnMail()
	{
		...
		var searchurl=getContextPath()+"/sendSettlementReportOnMail.html?fromDate="+fromDate+"&toDate="+toDate+"&posCode="+posCode;
		 $.ajax({
			        type: "POST",
			        url: searchurl,
			        dataType: "text",
...
<body >
	<div id="formHeading">
		<label>Settlement Wise Group Wise Breakup</label>
	</div>
	<s:form name="SettlementWiseGroupWiseBreakup" method="POST" action="rptPOSSettlementWiseGroupWiseBreakup.html?saddr=${urlHits}" target="_blank" class="formoid-default-skyblue" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:880px;min-width:150px;margin-top:2%;">
