...
<title>Hourly Item Wise Report</title>
<style>
.ui-autocomplete {
    max-height: 200px;
    overflow-y: auto;
...
<body>
<div id="formHeading">
		<label>Hourly ItemWise Sales Report</label>
	</div>
<s:form name="frmHourlyItemWiseReport" method="POST" action="rptHourlyItemWiseSalesReport.html?saddr=${urlHits}" target="_blank" class="formoid-default-skyblue" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:880px;min-width:150px;margin-top:2%;">
			...
			<div class="row" style="background-color: #fff;display: -webkit-box;">
				...
				<div class="element-input col-lg-6"
					...
					<s:select id="cmbDocType" path="strDocType">
						...
						<s:option value="A4 Size Report">A4 Size Report</s:option>
