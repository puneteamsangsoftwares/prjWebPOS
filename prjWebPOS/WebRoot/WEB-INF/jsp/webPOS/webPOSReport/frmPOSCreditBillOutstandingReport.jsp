...
<body>
	...
	<s:form name="POSCreditBillOutstandingReportForm" method="POST"
		...
		action="rptPOSCreditBillOutstandingReport.html?saddr=${urlHits}"
		target="_blank">
		...
		<div class="title" style="margin-left: 35%; width: 50%">
			...
			<div class="row"
				...
				<div class="element-input col-lg-6"
					style="width: 50%; margin-left: -10%">
					<s:select id="cmbDocType" path="strReportType">
		...
		<%-- <table class="masterTable">
			...
			<tr>
				<td width="30%">&emsp;&ensp;&emsp;&ensp; <label>POS
						Name</label></td>
			...
			<tr>
				<td>&emsp;&ensp;&emsp;&ensp; <label>From Date</label></td>
				<td><s:input id="txtFromDate" required="required"
						path="fromDate" pattern="\d{1,2}-\d{1,2}-\d{4}"
						cssClass="calenderTextBox" /></td>
				<td><label>To Date</label>&emsp;&ensp; <s:input id="txtToDate"
						required="required" path="toDate" pattern="\d{1,2}-\d{1,2}-\d{4}"
						cssClass="calenderTextBox" /></td>

			</tr>
			<tr>
				<td>&emsp;&ensp;&emsp;&ensp; <label>Report Type</label></td>
