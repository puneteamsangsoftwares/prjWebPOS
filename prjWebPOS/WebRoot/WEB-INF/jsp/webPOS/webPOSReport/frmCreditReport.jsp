...
<body>
	...
	<s:form name="POSCreditReportForm" method="POST"
		action="rptCreditReport.html?saddr=${urlHits}" target="_blank"
		...
		<div class="title" style="margin-left: 190px;">
			...
			<div class="row"
				style="background-color: #fff; display: block; margin-left: 10%;">
		...
		<div class="col-lg-9 col-sm-9 col-xs-9"
			...
			<p align="center">
			<div class="submit col-lg-3 col-sm-3 col-xs-3">
