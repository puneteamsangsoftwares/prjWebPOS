...
<title>Waiter Wise Item Report</title>
<style>
.ui-autocomplete {
	max-height: 200px;
	overflow-y: auto;
...
<body>
	<div id="formHeading">
		<label>Waiter Wise Item Report</label>
	</div>
	<s:form name="WaiterWiseItemReport" method="POST"
		action="rptWaiterWiseItemReport.html?saddr=${urlHits}" target="_blank"
		...
		<div class="title" style="margin-left: 190px;">
			...
			<div class="row"
				...
				<div class="element-input col-lg-6"
					style="margin-bottom: 10px; width: 30%">
					<s:select id="cmbSelectType" path="strWShortName"
						items="${waiterlist}">
					</s:select>
				</div>
			</div>
		...
		<div class="col-lg-10 col-sm-10 col-xs-10"
			style="width: 70%; margin-left: 160px;">
			<p align="center">
			<div class="submit col-lg-4 col-sm-4 col-xs-4">
				<input type="submit" value="SUBMIT" tabindex="3" />
			</div>
			<div class="submit col-lg-4 col-sm-4 col-xs-4">
				<input type="reset" value="CLOSE" onclick="funResetFields()" />
			</div>
			</p>
		</div>
	</s:form>
