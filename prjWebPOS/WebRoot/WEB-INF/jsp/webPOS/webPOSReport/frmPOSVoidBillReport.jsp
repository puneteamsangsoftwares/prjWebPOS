...
<body>
	...
	<s:form name="POSVoidBillReportForm" method="POST"
		action="rptPOSVoidBillReport.html?saddr=${urlHits}" target="_blank"
		...
		<div class="title" style="margin-left: 190px;">
			...
			<div class="row" style="background-color: #fff; display: block;">
				...
				<div class="element-input col-lg-6"
					style="margin-bottom: 10px; width: 30%">
					<s:select id="cmbReasonName" name="cmbReasonName"
						path="strReasonCode" items="${reasonList}">
					</s:select>
				</div>
			</div>
			...
			<%-- <div class="row" style="background-color: #fff; display: block;">
				<div class="element-input col-lg-6" style="width: 17%;">
					<label id="lblCurrency" style="display: inline-block; width: 100px">Currency
					</label>
				</div>
				<div class="element-input col-lg-6"
					style="margin-bottom: 10px; width: 30%">
