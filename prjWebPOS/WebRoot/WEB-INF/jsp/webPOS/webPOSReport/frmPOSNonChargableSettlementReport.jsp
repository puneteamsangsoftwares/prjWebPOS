	...
	<s:form name="POSNonChargeableKOTReportForm" method="POST" action="rptNonChargeableSettlementReport.html?saddr=${urlHits}" target="_blank" class="formoid-default-skyblue" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:880px;min-width:150px;margin-top:2%;">
		...
		<div class="title" style="margin-left: 190px;">
			...
			<div class="row" style="background-color: #fff;display: -webkit-box;">
			 ...
			 <div class="row" style="background-color: #fff;display: -webkit-box;">			
			 		<div class="element-input col-lg-6" style="width: 19%;"> 
    					<label class="title">Reason Master</label>
	    			</div>
	    			<div class="element-input col-lg-6" style="margin-bottom:  10px;width: 30%"> 
						<s:select id="cmbReasonMaster" path="strReasonMaster" items="${ReasonMasterList}">
				    	</s:select>
					</div>
			 </div>
			  <div class="row" style="background-color: #fff;display: -webkit-box;">			
