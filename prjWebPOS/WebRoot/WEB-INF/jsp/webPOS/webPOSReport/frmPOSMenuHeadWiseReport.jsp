...
<title>Menu Head Wise Report</title>
<style>
.ui-autocomplete {
    max-height: 200px;
    overflow-y: auto;
...
<body>
<div id="formHeading">
		<label>Menu Head Wise Report</label>
	</div>
	<s:form name="MenuHeadWiseReport" method="POST" action="rptMenuHeadWiseReport.html?saddr=${urlHits}" target="_blank" class="formoid-default-skyblue" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:880px;min-width:150px;margin-top:2%;">
		<br />
		<br />
