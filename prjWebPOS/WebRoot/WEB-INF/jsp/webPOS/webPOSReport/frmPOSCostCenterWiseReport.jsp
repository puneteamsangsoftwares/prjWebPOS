		...
		<br />
		 <div class="title" style="margin-left: 190px;">
		 	...
		 	<div class="row" style="background-color: #fff;display: -webkit-box;">
		 		...
		 		<div class="element-input col-lg-6" style="margin-bottom:  10px;width: 25%"> 
		 			<s:select id="cmbSGName" name="cmbSGName" path="strSGName" items="${costCenterList}" >
					</s:select>
		 		</div>
		 	</div>
		 	<div class="row" style="background-color: #fff;display: -webkit-box;">
