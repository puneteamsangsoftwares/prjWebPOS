				...
				.ajax({
					...
					success : function(response) {
						...
						if (response.strShowUnSettlementForm == 'Y') {
							$("#chkShowUnSettlementForm").prop('checked', true);
						} else
							$("#chkShowUnSettlementForm")
									.prop('checked', false);

						if (response.strScanQRYN == 'Y') {
							$("#strScanQRYN").prop('checked', true);
						} else
							$("#chkScanQRYN").prop('checked', false);
						...
						if (response.strEffectOfSales == 'Y') {
							$("#chkEffectOfSales").prop('checked', true);
						} else
							$("#chkEffectOfSales").prop('checked', false);
						...
						if (response.strPostRoundOffToWebBooks == 'Y') {
							$("#strPostRoundOffToWebBooks").prop('checked',
									true);
						} else
							$("#strPostRoundOffToWebBooks").prop('checked',
									false);
						...
						if (response.strPostSalesDataToExcise == 'Y') {
							$("#strPostSalesDataToExcise")
									.prop('checked', true);
						} else
							$("#strPostSalesDataToExcise").prop('checked',
									false);
...
<body onload="funFillPOSData()">
	...
	<s:form name="POSForm" method="POST" action="savePOSPropertySetup.html"
		...
		<table
			style="border: 0px solid black; width: 95%; height: 130%; margin-left: auto; margin-right: auto;">
				...
				<td>
					<div id="tab_container">
						...
						<div id="tab1" class="tab_content">
							<br> <br>
							<div style="float: left; margin-left: 20%; margin-top: -3%">
								<div class="row"
									...
									<div class="element-input col-lg-6"
										...
										<s:input class="large" colspan="3" type="text"
											...
											ondblclick="funHelp('POSTaxMaster.a')" />
									</div>
									<div class="element-input col-lg-6"
										style="margin-bottom: 10px; width: 30%;">
										<s:input class="large" colspan="3" type="text"
											id="txtClientName" path="strClientName" />
									</div>
					...
					<div id="tab2" class="tab_content">
						<div style="float: left; margin-left: 18%; margin-top: -40%">
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									...
									<s:select id="cmbBillFormatType" name="cmbBillFormatType"
										...
										<option value="Format 1">Jasper 1</option>
										<option value="Format 2">Jasper 2</option>
										<option value="Format 3">Jasper 3</option>
										<option value="Format 4">Jasper 4</option>
										<option value="Format 5">Jasper 5</option>
										<option value="Format 6">Jasper 6</option>
										<option value="Format 7">Jasper 7</option>
										<option value="Format 8">Jasper 8</option>
										<option value="Format 9">Jasper 9</option>
										<option value="Format 10">Jasper 10</option>
										<option value="Format 11">Jasper 11</option>
									</s:select>
								</div>
								<div class="element-input col-lg-6" style="width: 30%;">
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									...
									<s:checkbox element="li" id="chkMultiBillPrint"
										path="chkMultiBillPrint" value="Yes" />
								</div>
								<div class="element-input col-lg-6"
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									style="width: 20%; margin-bottom: 10px;">
									<s:checkbox element="li" id="chkMultiKOTPrint"
										path="chkMultiKOTPrint" value="Yes" />
								</div>
								<div class="element-input col-lg-6" style="width: 30%;">
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									style="margin-bottom: 10px; width: 20%; margin-bottom: 10px;">
					...
					<div id="tab3" class="tab_content">
						...
						<div style="float: left; margin-left: 17%; margin-top: -39%">
							<div class="row"
								style="background-color: #fff; display: -webkit-box;">
								<div class="element-input col-lg-6" style="width: 20%;">
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									...
									<s:input type="text" element="li" id="txtMaxDiscount"
										path="dblMaxDiscount" />
								</div>
							</div>
							<div class="row"
 ...
 --%>
							...
							<div class="row"
								...
								<div class="element-input col-lg-6" style="width: 20%;">
									<s:checkbox element="li" id="chkSkipWaiterSelection"
										path="chkSkipWaiterSelection" value="Yes" />
								</div>
								<div class="element-input col-lg-6"
									style="margin-bottom: 10px; width: 40%; margin-left: 10%">
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									...
									<s:checkbox element="li"
										id="chkPOSWiseItemToMMSProductLinkUpYN"
					...
					<div id="tab5" class="tab_content">
						<div style="float: left; margin-left: 18%; margin-top: -40%">
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									...
									<s:checkbox element="li" id="chkCheckDebitCardBalOnTrans"
										path="chkCheckDebitCardBalOnTrans" value="Yes" />
								</div>
								<div class="element-input col-lg-6" style="width: 40%;">
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									style="width: 15%; margin-bottom: 10px;">
									<%-- <s:input type="text" id="chkSetUpToTimeForAdvOrder"
										path="chkSetUpToTimeForAdvOrder" /> --%>
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									...
									<s:checkbox element="li" id="chkEnableBillSeries"
										path="chkEnableBillSeries" value="Yes" />
								</div>
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									style="width: 10%; margin-bottom: 5px;">
									<s:checkbox element="li" id="chkPropertyWiseSalesOrder"
										path="chkPropertyWiseSalesOrder" value="Yes" />
								</div>
								<div class="element-input col-lg-6"
									style="width: 30%; margin-left: 10%">
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									style="width: 10%; margin-bottom: 5px;">
									<s:checkbox element="li" id="chkUnSettlementFrom"
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									...
									<input type="text" element="li" id="txtRoundOff"
										path="dblRoundOff" value="0.0" />
								</div>
								...
								<div class="element-input col-lg-6"
									style="width: 10%; margin-bottom: 5px;">
									<input type="text" element="li" id="txtShowPopItemsOfDays"
										path="intShowPopItemsOfDays" value="1" />
								</div>
								<div class="element-input col-lg-6"
									style="width: 30%; margin-left: 10%">
					...
					<div id="tab6" class="tab_content">
						<div style="float: left; margin-left: 20%; margin-top: -39%">
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									style="margin-bottom: 10px; width: 30%; margin-left: -10%">
									<s:checkbox element="li" id="chkAreaWiseCostCenterKOTPrinting"
										path="chkAutoAreaSelectionInMakeKOT" value="Yes" />
								</div>
								<div class="element-input col-lg-6"
									style="margin-bottom: 10px; width: 40%; margin-left: -20%">
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									style="margin-bottom: 10px; width: 20%; margin-left: -10%">
									<s:select id="cmbHomeDeliAreaForDirectBiller"
										path="strHomeDeliAreaForDirectBiller" items="${areaList}">
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									style="margin-bottom: 10px; width: 20%; margin-left: -5%">
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									style="margin-bottom: 10px; width: 40%; margin-left: 0%">
									<s:checkbox element="li" id="strPrintOriginalOnBill"
							...
							<div class="row"
								style="background-color: #fff; display: -webkit-box; margin-bottom: 10px;">
								<div class="element-input col-lg-6" style="width: 30%;">
									<label class="title">Blank Day End Print
										</label>
								</div>
								...
								<div class="element-input col-lg-6"
									style="margin-bottom: 10px; width: 40%; margin-left: -5%">
									<s:checkbox element="li" id="strPostRoundOffToWebBooks"
							...
							<div class="row"
								style="background-color: #fff; display: -webkit-box; margin-bottom: 10px;">
								<div class="element-input col-lg-6" style="width: 30%;">
									<label class="title">Display Total Show Bill
										</label>
								</div>
								...
								<div class="element-input col-lg-6"
									style="margin-bottom: 10px; width: 40%; margin-left: -5%">
									<s:checkbox element="li" id="strPostSalesDataToExcise"
					...
					<div id="tab7" class="tab_content">
						<div style="float: left; margin-left: 30%; margin-top: -40%">
							<div class="row"
								style="background-color: #fff; display: -webkit-box;">
					...
					<div id="tab10" class="tab_content">
						<div style="float: left; margin-left: 20%; margin-top: -40%">
							...
							<div class="row"
								...
								<div class="element-input col-lg-6"
									...
									<s:input class="large" colspan="3" type="text"
										id="txtSMSMobileNo" path="longSMSMobileNo" style="width: 100%" />
								</div>
								<div class="element-input col-lg-6"
					...
					<div id="tab12" class="tab_content">
						...
						<div style="float: left; margin-left: 20%; margin-top: -40%">
							<div class="row"
								...
								<div class="element-input col-lg-6"
									style="margin-bottom: 10px; width: 20%; margin-left: 0%; margin-bottom: 10px">
					...
					<div id="tab13" class="tab_content">
						<div style="float: left; margin-left: 30%; margin-top: -38%">
							...
							<table border="1" style="width: 100%; margin: auto;">
								...
								<tr>
									...
									<td
										style="width: 30%; border: #c0c0c0 1px solid; background: #78BEF9;">Cost
										Center Name</td>
									<td
										style="width: 25%; border: #c0c0c0 1px solid; background: #78BEF9;">Primary
										Printer</td>
									<td
										style="width: 25%; border: #c0c0c0 1px solid; background: #78BEF9;">Secondary
										Printer</td>
									<td
										style="width: 60%; border: #c0c0c0 1px solid; background: #78BEF9;">Print
										On Both Printer</td>
								</tr>
							</table>
							<div
					...
					<div id="tab18" class="tab_content">
						...
						<div style="float: left; margin-left: 30%; margin-top: -40%">
							<div class="row"
								...
								<div class="element-input col-lg-6"
									style="margin-bottom: 10px; width: 60%;">
									<s:select id="cmbWeraIntegrationYN" path="strWeraIntegrationYN">
										<option value="N">No</option>
										<option value="Y">Yes</option>
									</s:select>
								</div>
