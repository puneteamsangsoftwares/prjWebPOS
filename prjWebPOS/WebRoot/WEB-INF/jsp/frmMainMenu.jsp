  ...
  <head>
	...
	Desktop
		...
		<c:forEach items="${desktop}" var="draw1" varStatus="status1">
			<div class="mainMenuIcon" style="border:1px solid black;">
				<div style="padding-left: 30%; padding-right: 10%">
				<a href="${draw1.strRequestMapping}?saddr=1"><img id="Desktop" src="../${pageContext.request.contextPath}/resources/images/${draw1.strImgName}.png" title="${draw1.strFormDesc}" ></a>
				</div>
