					...
					<div style="width: 340px; height: 115px;">
						<table>
							...
							<tr>
								...
								<td><s:input cssClass="loginInput numeric" name="txtclientCode" placeholder="Client Code"
									path="strClientCode" autocomplete="off" id="txtclientCode" />
							...
							<tr>
								...
								<td><s:input type="password" placeholder="Password"
										required="true" cssClass="loginInput" name="txtpassword" id="txtpassword" 
