...
@Controller
public class clsPOSJasperFormat1ForBill implements clsPOSBillGenerationFormat
{
	@Autowired
	...
	public void funGenerateBill(String strBillNo, String reprint, String transactionType, String strPosCode, String strBillDate, String strClientCode, String strServerBillPrinterName, boolean isOriginal)
	{
		...
		//	final String gDecimalFormatString = clsGlobalFunctions.funGetGlobalDecimalFormatString(strClientCode, strPosCode);
			...
			if (listDisc.size() > 0)
			{
				...
				/*
				 * String discountOnItem = objUtility.funPrintTextWithAlignment
			...
			{
				reportName = "com/POSGlobal/reports/rptBillFormat1JasperReportHD.jrxml";
			}
			/*
			 * else if (result == 1) { reportName =
			 * "com/POSGlobal/reports/rptBillFormat1JasperReportNormalBill.jrxml"
			 * ; }
			 */
			else
			{
				reportName = "com/POSGlobal/reports/rptBillFormat1JasperReportNormalBill.jrxml";
			}
