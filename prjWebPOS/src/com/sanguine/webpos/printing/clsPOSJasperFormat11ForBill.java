...
@Controller
public class clsPOSJasperFormat11ForBill implements clsPOSBillGenerationFormat
{
	@Autowired
	...
	public void funGenerateBill(String strBillNo, String reprint, String transactionType,String strPosCode, String strBillDate,String strClientCode,String strServerBillPrinterName, boolean isOriginal)
    {
		...
		try
		{
			//String reportName = servletContext.getRealPath("/WEB-INF/reports/billFormat/rptBillFormat4JasperReport.jrxml");
            ...
            JasperDesign jd = JRXmlLoader.load(servletContext.getResourceAsStream(("/WEB-INF/reports/billFormat/rptBillFormat11JasperHeader.jrxml")));
