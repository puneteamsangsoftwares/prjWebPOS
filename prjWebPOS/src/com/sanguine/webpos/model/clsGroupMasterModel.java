...
@NamedQueries({ @NamedQuery(name = "getAllGroupMaster", 
query = "select m.strGroupCode,m.strGroupName,m.strOperationalYN " 
		+ "from clsGroupMasterModel m where m.strClientCode=:clientCode "),

		@NamedQuery(name = "getGroupMaster", 
		query = "from clsGroupMasterModel where strGroupCode=:groupCode and strClientCode=:clientCode")})
