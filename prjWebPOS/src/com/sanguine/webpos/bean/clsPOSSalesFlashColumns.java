...
public class clsPOSSalesFlashColumns {
    ...
    public static Comparator<clsPOSSalesFlashColumns> getComparatorSalesFlashColumnDtl() {
        return comparatorSalesFlashColumnDtl;
    }

    public static void setComparatorSalesFlashColumnDtl(Comparator<clsPOSSalesFlashColumns> comparatorSalesFlashColumnDtl) {
        clsPOSSalesFlashColumns.comparatorSalesFlashColumnDtl = comparatorSalesFlashColumnDtl;
    }
    ...
    public static Comparator<clsPOSSalesFlashColumns> comparatorSalesFlashColumnDtl = new Comparator<clsPOSSalesFlashColumns>()
    {
        public int compare(clsPOSSalesFlashColumns s1, clsPOSSalesFlashColumns s2)
        {
