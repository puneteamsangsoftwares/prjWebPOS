...
//Variable Declaration
	...
	private String strNCTable;
	
	private String tmeTimeDiff;

	private String strBarTable;
...
public List<clsPOSTableMasterBean> getListTableDtl() {
	...
	public String getStrNCTable() {
		return strNCTable;
	}
	public void setStrNCTable(String strNCTable) {
		this.strNCTable = strNCTable;
	}
	public String getTmeTimeDiff() {
		return tmeTimeDiff;
	}
	public void setTmeTimeDiff(String tmeTimeDiff) {
		this.tmeTimeDiff = tmeTimeDiff;
	}
	public String getStrBarTable()
	{
		return strBarTable;
	}
	public void setStrBarTable(String strBarTable)
	{
		this.strBarTable = strBarTable;
	}
