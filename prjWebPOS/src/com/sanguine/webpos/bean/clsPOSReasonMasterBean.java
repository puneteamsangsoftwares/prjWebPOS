...
public class clsPOSReasonMasterBean 
{
	   ...
	   private String strHashTagLoyaltyIntf;
	   private String strMoveKOT;
	...
	public void setStrTransferEntry(String strTransferEntry) {
		this.strTransferEntry = strTransferEntry;
	}
	...
	public void setStrNCKOT(String strNCKOT) {
		this.strNCKOT = strNCKOT;
	}
	public String getStrVoidAdvOrder() {
		return strVoidAdvOrder;
	}
	public void setStrVoidAdvOrder(String strVoidAdvOrder) {
		this.strVoidAdvOrder = strVoidAdvOrder;
	}
	public String getStrReprint() {
		return strReprint;
	}
	public void setStrReprint(String strReprint) {
		this.strReprint = strReprint;
	}
	public String getStrHashTagLoyaltyIntf() {
		return strHashTagLoyaltyIntf;
	}
	public void setStrHashTagLoyaltyIntf(String strHashTagLoyaltyIntf) {
		this.strHashTagLoyaltyIntf = strHashTagLoyaltyIntf;
	}
	public String getStrMoveKOT() {
		return strMoveKOT;
	}
	public void setStrMoveKOT(String strMoveKOT) {
		this.strMoveKOT = strMoveKOT;
	}
