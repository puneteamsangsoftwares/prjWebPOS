...
public class clsPOSReportBean {
    ...
    private String strPrintModifiers;
	...
	public static void setListSettelmentOptions(List<String> listSettelmentOptions) {
		clsPOSReportBean.listSettelmentOptions = listSettelmentOptions;
	}
	...
	public String getStrPrintModifiers() {
		return strPrintModifiers;
	}

	public void setStrPrintModifiers(String strPrintModifiers) {
		this.strPrintModifiers = strPrintModifiers;
	}
	...
	public String getDblUSDConverionRate()
	{
		return dblUSDConverionRate;
	}

	public void setDblUSDConverionRate(String dblUSDConverionRate)
	{
		this.dblUSDConverionRate = dblUSDConverionRate;
	}

	public String getStrVoidedBill()
	{
		return strVoidedBill;
	}

	public void setStrVoidedBill(String strVoidedBill)
	{
		this.strVoidedBill = strVoidedBill;
	}
