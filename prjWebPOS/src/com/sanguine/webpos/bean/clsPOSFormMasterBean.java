...
public class clsPOSFormMasterBean 
{
	...
	private List<clsPOSFormMasterBean> listMastersDtl;
	...
	public List<clsPOSFormMasterBean> getListMastersDtl() {
		return listMastersDtl;
	}

	public void setListMastersDtl(List<clsPOSFormMasterBean> listMastersDtl) {
