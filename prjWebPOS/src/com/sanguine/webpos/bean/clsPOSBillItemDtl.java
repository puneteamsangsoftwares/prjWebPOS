...
public class clsPOSBillItemDtl {
	    ...
	    public clsPOSBillItemDtl()
	    {
	        //default
	    }

	    //for item wise sales flash
	    public clsPOSBillItemDtl(String billDateTime, String itemCode, String itemName, double quantity, double amount, double discountAmount, String posName, double subTotal)
	    {
	    ...
	    public clsPOSBillItemDtl(double quantity, double amount, double discountAmount, String posName, double subTotal, String menuCode, String menuName)
	    {
	        this.quantity = quantity;
	        this.amount = amount;
	        this.discountAmount = discountAmount;
