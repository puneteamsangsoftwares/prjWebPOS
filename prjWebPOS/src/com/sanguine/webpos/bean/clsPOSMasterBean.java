...
public class clsPOSMasterBean {
	
	private List<clsPOSSettlementDetailsBean> listSettlementDtl;
	
	private List<clsPOSReorderTimeBean> listReorderTime;
	...
	public void setListSettlementDtl(List<clsPOSSettlementDetailsBean> listSettlementDtl) {
		this.listSettlementDtl = listSettlementDtl;
	}

	public List<clsPOSReorderTimeBean> getListReorderTime() {
		return listReorderTime;
	}

	public void setListReorderTime(List<clsPOSReorderTimeBean> listReorderTime) {
		this.listReorderTime = listReorderTime;
	}
