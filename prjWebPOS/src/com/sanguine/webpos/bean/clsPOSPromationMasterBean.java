...
public class clsPOSPromationMasterBean {
	...
	private List<clsPOSBuyPromotionItemDtl> listBuyPromotionDtl;
	
	private List<clsPOSGetPromotionItemDtl> listGetPromotionDtl;
	...
	public List<clsPOSPromotionDayTimeDtlBean> getListPromotionDayTimeDtl() {
		return listPromotionDayTimeDtl;
	}

	public void setListPromotionDayTimeDtl(
			List<clsPOSPromotionDayTimeDtlBean> listPromotionDayTimeDtl) {
	...
	public List<clsPOSBuyPromotionItemDtl> getListBuyPromotionDtl()
	{
		return listBuyPromotionDtl;
	}

	public void setListBuyPromotionDtl(List<clsPOSBuyPromotionItemDtl> listBuyPromotionDtl)
	{
		this.listBuyPromotionDtl = listBuyPromotionDtl;
	}

	public List<clsPOSGetPromotionItemDtl> getListGetPromotionDtl()
	{
		return listGetPromotionDtl;
	}

	public void setListGetPromotionDtl(List<clsPOSGetPromotionItemDtl> listGetPromotionDtl)
	{
