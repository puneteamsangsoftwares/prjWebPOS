...
public class clsPOSDebitCardMasterBean{
//Variable Declaration
	private List<clsPOSSettlementDetailsBean> listSettlementDtl;
	...
	private long strValidityDays;

	private double strCardValueFixed;
	...
	private double strRedemptionLimitValue;
...
//Setter-Getter Methods
	...
	public void setStrDebitOnCredit(String strDebitOnCredit){
		this.strDebitOnCredit=strDebitOnCredit;
	}
	...
	public void setStrComplementary(String strComplementary){
		this.strComplementary=strComplementary;
	}
	...
	public void setStrAutoTopUp(String strAutoTopUp){
		this.strAutoTopUp=strAutoTopUp;
	}
	...
	public void setStrRedeemableCard(String strRedeemableCard){
		this.strRedeemableCard=strRedeemableCard;
	}
	...
	public void setStrCardInUse(String strCardInUse){
		this.strCardInUse=strCardInUse;
	}
	...
	public void setStrEntryCharge(String strEntryCharge){
		this.strEntryCharge=strEntryCharge;
	}
	...
	public void setStrCoverCharge(String strCoverCharge){
		this.strCoverCharge=strCoverCharge;
	}
	...
	public void setStrDiplomate(String strDiplomate){
		this.strDiplomate=strDiplomate;
	}
	...
	public void setStrAllowTopUp(String strAllowTopUp){
		this.strAllowTopUp=strAllowTopUp;
	}
	...
	public void setStrExValOnTopUp(String strExValOnTopUp){
		this.strExValOnTopUp=strExValOnTopUp;
	}
	...
	public void setStrSetExpiryDt(String strSetExpiryDt){
		this.strSetExpiryDt=strSetExpiryDt;
	}
	...
	public void setStrCurrentFinacialYr(String strCurrentFinacialYr){
		this.strCurrentFinacialYr=strCurrentFinacialYr;
	}
	...
	public double getStrCardValueFixed() {
		return strCardValueFixed;
	}
	public void setStrCardValueFixed(double strCardValueFixed) {
		this.strCardValueFixed = strCardValueFixed;
	}
	public double getDblMinVal(){
		return dblMinVal;
	}
	public void setDblMinVal(double dblMinVal){
		this.dblMinVal=dblMinVal;
	}
	...
	public void setDblMinCharge(double dblMinCharge){
		this.dblMinCharge=dblMinCharge;
	}
	...
	public void setStrPayModCash(String strPayModCash){
		this.strPayModCash=strPayModCash;
	}
	...
	public void setStrPayModParty(String strPayModParty){
		this.strPayModParty=strPayModParty;
	}
	...
	public void setStrPayModMember(String strPayModMember){
		this.strPayModMember=strPayModMember;
	}
	...
	public void setStrPayModCreditCard(String strPayModCreditCard){
		this.strPayModCreditCard=strPayModCreditCard;
	}
	...
	public void setStrPayModStaff(String strPayModStaff){
		this.strPayModStaff=strPayModStaff;
	}
	...
	public void setStrPayModCheque(String strPayModCheque){
		this.strPayModCheque=strPayModCheque;
	}
	...
	public void setDblMaxRefundAmt(double dblMaxRefundAmt){
		this.dblMaxRefundAmt=dblMaxRefundAmt;
	}
	...
	public void setStrRedemptionLimitType(String strRedemptionLimitType){
		this.strRedemptionLimitType=strRedemptionLimitType;
	}
	...
	public void setStrCustomerCompulsory(String strCustomerCompulsory){
		this.strCustomerCompulsory=strCustomerCompulsory;
	}
	...
	public void setStrAuthorizeMemberCard(String strAuthorizeMemberCard){
		this.strAuthorizeMemberCard=strAuthorizeMemberCard;
	}
	...
	public long getStrValidityDays() {
		return strValidityDays;
	}
	public void setStrValidityDays(long strValidityDays) {
		this.strValidityDays = strValidityDays;
	}
	public double getStrRedemptionLimitValue() {
		return strRedemptionLimitValue;
	}
	public void setStrRedemptionLimitValue(double strRedemptionLimitValue) {
		this.strRedemptionLimitValue = strRedemptionLimitValue;
	}
	public List<clsPOSSettlementDetailsBean> getListSettlementDtl() {
		return listSettlementDtl;
	}
	public void setListSettlementDtl(
			List<clsPOSSettlementDetailsBean> listSettlementDtl) {
