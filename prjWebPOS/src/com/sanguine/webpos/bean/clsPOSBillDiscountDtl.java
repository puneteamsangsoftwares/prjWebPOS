...
public class clsPOSBillDiscountDtl {
    ...
    public clsPOSBillDiscountDtl()
    {        
    }    

    public clsPOSBillDiscountDtl(String remark, String reason, double discPer, double discAmt, double discOnAmt)
    {
        this.remark = remark;
        this.reason = reason;
