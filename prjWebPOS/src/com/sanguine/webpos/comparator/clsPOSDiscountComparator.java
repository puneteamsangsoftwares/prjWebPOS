...
public class clsPOSDiscountComparator implements Comparator<clsPOSBillItemDtlBean>
{

    private List<Comparator<clsPOSBillItemDtlBean>> listComparators;

    @SafeVarargs
    public clsPOSDiscountComparator(Comparator<clsPOSBillItemDtlBean>... comparators)
    {
