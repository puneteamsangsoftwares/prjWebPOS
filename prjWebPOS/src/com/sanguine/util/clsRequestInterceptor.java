...
public class clsRequestInterceptor implements HandlerInterceptor 
{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if (!request.getRequestURI().equals(prjName) && !request.getRequestURI().equals(prjName + "index.html")
				...
				&& !request.getRequestURI().equals(prjName + "validateClient.html")
				&& !request.getRequestURI().equals(prjName + "logout.html")
				&& !request.getRequestURI().equals(prjName + "updateStructure.html")) {

			if (null == request.getSession().getAttribute("gUserCode")) {
