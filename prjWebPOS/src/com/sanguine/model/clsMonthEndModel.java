...
@IdClass(clsMonthEndModel_ID.class)
public class clsMonthEndModel implements Serializable{
	...
	public clsMonthEndModel(){}
	public clsMonthEndModel (clsMonthEndModel_ID clsMonthEndModel_ID) {
	...
	@Id
	@AttributeOverrides({
		@AttributeOverride(name = "strMonthEnd",column = @Column(name="strMonthEnd")),
