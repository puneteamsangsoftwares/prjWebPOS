...
public class clsSetupMasterDaoImpl implements clsSetupMasterDao{
	...
	/*
	 * (non-Javadoc)
	 * @see com.sanguine.dao.clsSetupMasterDao#funAddUpdateProcessSetup(com.sanguine.model.clsProcessSetupModel)
	 * to insert data into tblprocesssetup
	 */
	...
	public clsPropertySetupModel funGetObjectPropertySetup(String propertyCode,
		...
		//String sql="Select  a.strCompanyCode,a.strPropertyCode,a.dblBondAmt,a.dtEnd from tblpropertysetup a where a.strPropertyCode=: and  a.strClientCode =:clientCode ";
		String sql="SELECT a.strCompanyCode,a.strPropertyCode,a.dblBondAmt,a.dtFromTime,a.dtToTime, "
				+" a.intDueDays,a.intId,a.strAcceptanceNo,a.strAdd1,a.strAdd2,a.strCity,a.strState,a.strCountry,a.strPin,a.strAsseeCode,a.strBAdd1,a.strBAdd2, " 
				+" a.strBCity,a.strBCountry,a.strBPin,a.strBState,a.strBankAccountNo,a.strBankAdd1,a.strBankAdd2,a.strBankCity,a.strBankName,a.strBranchName, "
				+ "a.strCST,a.strCommi,a.strDivision,a.strEmail ,a.strFax,a.strLocCode,a.strNegStock,a.strPOBOM,a.strPanNo "
...
//		query.setParameter("clientCode", clientCode);
		...
		String sql2="SELECT a.strPhone,a.strPurEmail,a.strRangeDiv,a.strRegNo,a.strSAdd1,a.strSAdd2,a.strSCity,a.strSCountry,a.strSOBOM,a.strSPin,a.strSState, "
					+" a.strSaleEmail,a.strSerTax,a.strSwiftCode,a.strTotalWorkhour,a.strVAT,a.strWebsite,a.strWorkFlowbasedAuth ,a.strIndustryType,a.strLate,a.strRej, "
					+" a.strPChange,a.strExDelay,a.strMask,a.strRangeAdd,a.intdec,a.strListPriceInPO,a.strCMSModule "
		...
		objSetUpModel.setStrState(objPropSetUp2[10].toString());
		...
		String sql3="SELECT a.strBatchMethod,a.strTPostingType,a.strAudit,a.strAutoDC,a.strUserCreated,a.dtCreatedDate,a.strUserModified,a.dtLastModified,a.strClientCode,a.intqtydec,a.strRatePickUpFrom, "
				   +" a.strShowReqVal,a.strShowStkReq,a.strShowValMISSlip,a.strChangeUOMTrans,a.strShowProdMaster,a.strAuditFrom,a.strShowProdDoc, "
				   +" a.strAllowDateChangeInMIS,a.strShowTransAsc_Desc,a.strNameChangeProdMast,a.strStkAdjReason,a.intNotificationTimeinterval, "
				   +" a.strMonthEnd,a.strShowAllProdToAllLoc,a.strLocWiseProductionOrder,a.strShowStockInOP,a.strShowAvgQtyInOP, "
				   + "a.strShowStockInSO,a.strShowAvgQtyInSO,a.strDivisionAdd,a.strEffectOfDiscOnPO,a.strInvFormat,a.strECCNo,  "
				   + "a.strSMSProvider,a.strSMSAPI,a.strSMSContent,strInvNote,strCurrencyCode,strShowAllPropCustomer,strEffectOfInvoice,strEffectOfGRNWebBook  "
				   +" FROM clsPropertySetupModel a where a.strPropertyCode='"+propertyCode+"' and  a.strClientCode ='"+clientCode+"' ";
