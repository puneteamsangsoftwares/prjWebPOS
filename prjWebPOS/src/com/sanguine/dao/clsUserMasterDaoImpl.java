...
public class clsUserMasterDaoImpl implements clsUserMasterDao {
	...
	public Map<String, String> funGetLocMapPropertyNUserWise(String propertyCode,String clientCode,String usercode,HttpServletRequest req) {
		...
		}else
		{
			...
			String sql =" select a.strLocCode,b.strLocName ,a.strModule from tbluserlocdtl a ,tbllocationmaster b "
					+ " where a.strLocCode=b.strLocCode  "
	...
	public Map<String,String> funGetUserBasedProperty(String strUserCode,String strClientCode) {
		 ...
		 Map<String,String> map = new TreeMap<String,String>();		
			...
			Query query = sessionFactory.getCurrentSession().createSQLQuery("select a.strPropertyCode,b.strPropertyName from tbluserlocdtl a,tblpropertymaster b  "
					+ " where a.strPropertyCode=b.strPropertyCode and a.strUserCode=:strUserCode and a.strClientCode=:strClientCode group by a.strPropertyCode ");
	...
	public HashMap<String, String> funGetUserBasedPropertyLocation(String strPropertyCode,String strUserCode,String strClientCode) {
		...
		HashMap<String, String> map = new HashMap<String, String>();		
			...
			Query query = sessionFactory.getCurrentSession().createSQLQuery("select a.strLocCode,c.strLocName "
					+ " from tbluserlocdtl a,tblpropertymaster b,tbllocationmaster c "
					+ " where a.strPropertyCode=b.strPropertyCode "
					+ " and a.strLocCode=c.strLocCode and a.strPropertyCode=:strPropertyCode  and a.strUserCode=:strUserCode "
					+ " and a.strClientCode=:strClientCode group by a.strLocCode  ");
			query.setParameter("strClientCode", strClientCode);
			query.setParameter("strUserCode", strUserCode);
